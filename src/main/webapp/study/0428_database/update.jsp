		...
		<table class="table table-bordered text-center">
			...
			<tr>
				<td colspan="2" class="text-center">
					...
					<input type="button" value="돌아가기" onclick="location.href='${ctp}/study/0428_database/memberMain.jsp';" class="btn btn-warning" /> <!-- 서버에 갔다왔기 때문에 이미 jsp를 벗어났기 때문에 절대경로를 줘야함 -->
				</td>
			</tr>
		</table>
	</form>

...
<script>
	...
	function gugudan() {
		...
		location.href="${ctp}/cvhjajfdjdfhkyiwkscbyqwpeoshdlbl/Test5_3.mi?dan="+dan;
	}
</script>
<body>
...
<div class='container'>
	...
	<div>
		...
		<input type="button" value="구구단출력(5_3출력)" onclick="gugudan()" class="btn btn-secondary mt-3" /> 
	</div>
</div>
<p><br /></p>

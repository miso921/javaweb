...
public class AjaxTest5 extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// JSON 형식은 구성이 비슷한 map 형식으로 가져오는게 가장 좋다
...
//		System.out.println("map : " + map);
		...
		// JSON형식의 자료를 사용하기 위해 JSON객체를 생성할 수 있는 lib 추가
		// 주소 : https://code.google.com/archive/p/json-simple/downloads : 첫번째 파일 다운로드 후 lib 폴더에 추가하기

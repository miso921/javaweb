...
public class Test10 extends HttpServlet {
	@Override
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {   // get, post 무슨 방식이든 관계없이 값을 가져올 수 있는 메소드
